...
<header class="bg-white h-16 items-center relative shadow w-full z-10 md:h-20 lg:rounded-2xl">
		...
		<div class="flex items-center pl-1 relative w-full sm:pr-2 sm:ml-0 lg:max-w-68">
			<div class="flex h-full left-0 relative w-3/4">
				...
				<div class="flex group h-full items-center relative w-36 lg:w-64">
					...
					<input
						type="text"
						class="bg-gray-100 block leading-normal pl-10 py-1.5 pr-4 ring-opacity-90 rounded-2xl text-gray-400 w-full focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500"
						placeholder="Search"
					/>
					<div
